...
from classifier_control.classifier.models.latent_dynamics import LatentDynamicsTestTime
...
policy = {
    ...
    'learned_cost':LatentDynamicsTestTime,
    'learned_cost_model_path': os.environ['VMPC_EXP'] + '/classifier_control/distfunc_training/latent_dynamics_training/maze2d/weights/weights_ep199.pth',
