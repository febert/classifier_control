...
policy = {
    ...
    'learned_cost_model_path': os.environ['VMPC_EXP'] + '/classifier_control/distfunc_training/q_function_training/tabletop-texture/only_arm_state/weights/weights_ep995.pth',
