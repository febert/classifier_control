...
policy = {
    ...
    'learned_cost_model_path': os.environ['VMPC_EXP'] + '/classifier_control/distfunc_training/q_function_training/tabletop-texture/large_cap/weights/weights_ep199.pth',
