...
policy = {
    ...
    'learned_cost_model_path': os.environ['VMPC_EXP'] + '/classifier_control/distfunc_training/dist_q_func_training/tabletop-texture/resnet-50-smallimg/weights/weights_ep60.pth',
