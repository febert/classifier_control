...
policy = {
    ...
    'learned_cost_model_path': os.environ['VMPC_EXP'] + '/classifier_control/distfunc_training/tdist_multiway_classification/tabletop-texture/weights/weights_ep199.pth',
